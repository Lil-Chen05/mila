#!/bin/bash
#SBATCH --job-name=part1-direct-analysis
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=1-12:00:00
#SBATCH --output=logs/part1-direct-analysis-%j.out
...
srun --cpu-bind=none "$UV_BIN" run python scripts/analyze_part1.py \
  ...
  --direct-analysis-recovery-receipt "results/part1/$MODEL_RUN_ID/validation/direct_analysis_recovery_receipt.json" \
